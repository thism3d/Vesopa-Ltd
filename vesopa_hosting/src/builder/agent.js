...
Use ONLY the classes below. No <script>, <style>, forms, inputs, iframes, <svg> or external CSS; a style attribute only for a rare small tweak.
  ...
  Art / photo      <div class="v-art" data-emoji="🥐" data-photo="croissants cooling on a bakery counter"><span class="v-tag"><i class="v-i" data-i="star"></i> Baked at 5am</span></div>   variants .v-wide .v-square
  Photo tile       <figure class="v-ph" data-emoji="🍞" data-photo="sourdough loaves on a wooden board"><figcaption>Sourdough</figcaption></figure>
  ...
  hero     <section class="v-hero" id="hero"><div class="v-wrap v-hero-grid"><div><p class="v-eyebrow">Place · what</p><h1>Short promise with <em>one</em> accent</h1><p class="v-lead">..</p><div class="v-actions"><a class="v-btn" href="#menu">..</a><a class="v-btn v-ghost" href="#contact">..</a></div></div><div class="v-art" data-emoji="🥐" data-photo=".."><span class="v-tag">..</span></div></div></section>
  ...
  split    <div class="v-wrap v-split"><div class="v-art v-square" data-emoji="👩‍🍳" data-photo=".."></div><div>intro, <p>, <ul class="v-list"><li><i class="v-i" data-i="check"></i>..</li></ul></div></div>   .v-split.v-flip puts the art second
  ...
  gallery  <div class="v-gallery"><figure class="v-ph" data-emoji="🥖" data-photo=".."><figcaption>..</figcaption></figure> .. five or seven tiles</div>
...
PHOTOS. Every .v-art and .v-ph also carries data-photo: a few plain English words describing a REAL photograph of THIS business that a stock library would have -- what is in the frame, not a mood ("barber trimming a beard in a modern shop", "plates of biryani on a restaurant table", "wedding couple walking on a beach at sunset"). A real photo is found for it and replaces the emoji; the emoji is what shows until then, so keep a fitting one. Use a DIFFERENT description on every tile of a page, so no two show the same picture. Never write <img> yourself unless the customer gave you that image's address, and never write the photographer's credit: both are added for you.
