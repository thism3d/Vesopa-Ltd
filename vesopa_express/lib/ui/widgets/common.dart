...
/// What is in a dish, in the words of the fourteen: or a plain sentence saying
/// there are none, or that nobody has said -- which are different sentences to
/// read with an allergy.
class AllergenBlock extends StatelessWidget {
  const AllergenBlock({super.key, required this.codes, required this.declared, required this.s});
