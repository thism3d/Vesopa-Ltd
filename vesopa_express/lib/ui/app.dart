...
class _KioskShellState extends ConsumerState<KioskShell> {
  ...
  Widget build(BuildContext context) {
    ref.listen(orderFlowProvider.select((f) => f.step), (_, _) {
      _touched();
      // "1 x Halloumi Fries added" belongs to the menu. Carried onto the next
      // screen it sat over Pay now, where the customer's finger was going --
      // which the first live run found by tapping the message instead.
