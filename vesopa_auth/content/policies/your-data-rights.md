...
summary: The rights UK GDPR gives you over the data Vesopa OAuth holds, how to use each one, how long we take, and how to complain to the ICO if we get it wrong.
updated: 2026-09-08
---
...
| **Erasure** | Have your data deleted, where no legal obligation makes us keep it. | Delete your account yourself, or ask us. See [Data retention and deletion](/retention). |
...
The complete list is in section 3 of the [privacy policy](/privacy): your name, email address, phone number, date of birth, profile image, a hash of your password, your MFA enrolments and passkey public keys, IP addresses, user-agent and device information, sign-in timestamps and outcomes, and the list of applications you have connected.
...
- which right you are using, or just describe what you want in your own words — you do not have to cite the legislation and we will not hold it against you if you cite it wrongly;
- whether you want everything or a specific period or type of data. A narrower request is usually a faster one;
- for portability, the format you want.
...
- **Free.** Always. We charge nothing to exercise a right.
- **One month.** We respond within one calendar month of receiving your request and confirming who you are.
- **Plus two months, rarely.** If a request is genuinely complex, or you have made several, we may extend by up to two further months. If we do, we will tell you within the first month, and we will tell you why.
- **Refusals are explained.** We can refuse a request that is manifestly unfounded or excessive, or where an exemption applies — for instance, where giving you a record would reveal personal data about someone else. If we refuse, we say so, we say why, and we tell you that you can complain to us and to the ICO.
...
If you are not satisfied, you have the right to complain to the Information Commissioner's Office, the UK supervisory authority, at [ico.org.uk/make-a-complaint](https://ico.org.uk/make-a-complaint) or on 0303 123 1113.
