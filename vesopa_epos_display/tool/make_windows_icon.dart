...
//
// Copied from the till's tool of the same name rather than shared through a
// package: two applications, two repositories' worth of independence, and one
// file of arithmetic that has not changed since it was written.
